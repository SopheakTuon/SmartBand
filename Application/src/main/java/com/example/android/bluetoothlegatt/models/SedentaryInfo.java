...
//        if (SPUtils.getBoolean(context, SPUtils.SEDENTARINESS_NOTI_SWITCH, false)) {
//            this.isOn = 1;
//        } else {
//            this.isOn = 0;
//        }
//        String startTime = SPUtils.getString(context, SPUtils.SEDENTARINESS_START, BuildConfig.VERSION_NAME).trim();
...
//        }
//        String endTime = SPUtils.getString(context, SPUtils.SEDENTARINESS_END, BuildConfig.VERSION_NAME).trim();
